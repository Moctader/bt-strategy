class TradeManager:
    ...
    def borrow_share_and_sell_immediately(self, transactions, share_price, timestamp):        # Track borrowed shares for short selling
    ...
    def buy_back_borrowed_shares(self, transactions, share_price, timestamp):
        ...
        profit_loss = self.liquidated_borrow_shares - cost_to_buy_back  
